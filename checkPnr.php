...
<body>
  ...
  <nav class="navbar navbar-inverse">
     <div class="navbar-header">
         <strong><p id="navbarHeader" style="margin-left:10px;color: white;">Welcome User !</p></strong>
      </div>
...
<li> <a href="train_schedule.php">Find Train Schedule</a></li>
 ...
 <div class="jumbotron">
	  		...
	  		<form class="form-inline" action="" method="post">
   			...
   			{
   			$pnr=$_POST['pnr'];
   			$sql=mysqli_query($conn,"select * from ticket where pnrNum='$pnr' ");
   			$result=mysqli_fetch_assoc($sql);
   			$num=$result['trainNum'];
   			$train_name=mysqli_fetch_assoc(mysqli_query($conn,"select trainName from train 
   				                                            where trainNum='$num'"))['trainName'];
   			$count=mysqli_fetch_assoc(mysqli_query($conn,"select count(pnrNum) num from passengerinfo 
 ...
 $sql=mysqli_query($conn,"select name,age,coachNum,seatNum,bookingStatus,currentStatus from passengerinfo 
