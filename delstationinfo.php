...
<html>
	<head>
		<title>Delete station Info</title>
		<?php
			include("header.php");
			include("config.php");
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				$sql="DELETE FROM station WHERE stationCode='$stationCode'";
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="delstationinfo.php"><strong>Delete Station Info</strong></a></li>
				</ul>
			</div>
		</nav>
	...
	<div class="container">
			<form method="POST" class="form-horizontal">
				<div class="jumbotron">
				<p id="title">Delete Station Info :</p><hr>
					<div class="form-group">
						<label><strong>Select Station :</strong></label>
							<select id="stationCodeID" type="text" class="form-control" name="stationCode">
								<?php
