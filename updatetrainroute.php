		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="addFare.php"><strong>Add New Fare Info</strong></a></li>
					<li><a href="addNewRoute.php"><strong>Add Route</strong></a></li>
					<li><a href="addNewStation.php"><strong>Add Station Info</strong></a></li>
				</ul>
			</div>
		</nav>
	<div class="container">
			<div class="well well-sm">
				<p class="serif">Update Fare Info :</p>
			</div>
