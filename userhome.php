	...
	<input type="date" class="form-control" name="jdate" value="<?php if(isset($jdate)) echo $jdate;?>">
		...
		<div class="col-sm-6">
			<table class="table table-condensed">
				<tbody>
					<tr>
						<td><h3><a href="cancelticket.php"><b>Cancel Ticket</b></a></h3></td>
...
<li> <b>Select Quota:</b></li>
 <li> <input id='myquota'type="radio" name="quota" value="SS" tabindex="2">Senior Citizen/Pregnant Ladies</li>
 <li> <input id='myquota' type="radio" name="quota" value="GN" checked tabindex="2">GENERAL </li>
  <li> <input id='myquota' type="radio" name="quota" value="PH" tabindex="2">DIVYANGJAN </li>
 <li> <input id='myquota' type="radio" name="quota" value="LD" tabindex="2">LADIES</li>
</ul>
<script>
$(document).ready(function(){
console.log('run');	
$('td #train_classes').each(function(i,obj){
...
$(document).on("click","#myquota",function(){
	console.log('ok');
...
?>
    ...
    while($row5=mysqli_fetch_assoc($r5))
	  ...
	  ?>
     <a id ='train_classes' href=<?php echo "demo1.php?train=".$train['trainNum']."&class=".$row5['classCode']."&date=".$_GET['jdate']."&src=".rawurlencode($_GET['from'])."&dest=".rawurlencode($_GET['to'])?> style="text-decoration: none;" name="class1"> <?php echo $row5['classCode'] ?> </a>    
     <?php
      }
      ?>
     </td>
